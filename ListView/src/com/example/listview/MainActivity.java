...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		int[] imageIds = new int[] { R.drawable.image1, R.drawable.image2,
				...
				R.drawable.image6 };
		// Integer j=new Integer(R.drawable.image1);
		// j.toString();
		// Log.d("debug", j);
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> adpater, View view,
				...
				Toast.makeText(MainActivity.this, LINKS[index], Toast.LENGTH_SHORT).show();
			}
		});
		...
		//
		// ArrayAdapter<String> adapter =new
		// ArrayAdapter<>(this,R.layout.my_simple_list_item,data);
		//
		// listView.setAdapter(adapter);
