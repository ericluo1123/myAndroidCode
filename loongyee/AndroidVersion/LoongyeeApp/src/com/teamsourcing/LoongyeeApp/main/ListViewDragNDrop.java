 ...
 */
public class ListViewDragNDrop extends ListView {

    protected static final String TAG = "DragNDropListView";
    ...
    public ListViewDragNDrop(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
...
//		Log.i(TAG,"touch=" + action +" /x="+x +" /y="+y) ;
