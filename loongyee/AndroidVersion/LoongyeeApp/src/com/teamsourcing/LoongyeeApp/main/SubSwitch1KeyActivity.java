 ...
 */
public class SubSwitch1KeyActivity extends Activity implements View.OnClickListener {
    private Button back;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.subswitch1key);
...
//        }
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.back) {
            ...
            intent.setClass(SubSwitch1KeyActivity.this, SwitchsetActivity.class);
            startActivity(intent);
            finish();
        } else if (view.getId() == R.id.turn_off_all){
            String SyncURL ="http://192.168.1.1/cgi-bin/spi_send?data=15,00,02,00,00,00,00,00,00,00,00,00,00,01,01,01,00,00,00,00,00,01,0D";
               /*建立HTTP Get聯機*/
...
//            String SyncURL="http://www.google.com";
            String SyncURL ="http://192.168.1.1/cgi-bin/spi_send?data=15,00,02,00,00,00,00,00,00,00,00,00,00,01,01,01,01,00,00,00,00,01,0D";
          /*建立HTTP Get聯機*/
            HttpGet httpRequest = new HttpGet(SyncURL);
            try
            {
